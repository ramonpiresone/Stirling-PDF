...
def check_for_differences(reference_file, file_list, branch, actor):
    ...
    if has_differences:
        ...
        report.append("")
        report.append(
            f"@{actor} please check your translation if it conforms to the standard. Follow the format of [messages_en_GB.properties](https://github.com/EditMyPDF-Tools/EditMyPDF/blob/main/src/main/resources/messages_en_GB.properties)"
        )
    else:
